<%@ Page Title="QUẢN TRỊ NỘI DUNG" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LocationEdit.aspx.cs" Inherits="System_Edit_LocationEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="title_post_from">
        <div style="float: left; width: 12%;">Tỉnh thành</div>
...
<%--            <div style="float: right; text-align: right;">
    ...
    <div class="line_post_from">
        ...
        <div class="main_post_from">
            <input id="txtBkColor" runat="server" class="input_post_from" />
        </div>
    </div>
</asp:Content>
