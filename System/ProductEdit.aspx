<%@ Page Title="QUẢN TRỊ NỘI DUNG"  ValidateRequest="false"  Language="C#" MasterPageFile="~/MasterPage.master"
     ...
     <div style="width: 100%; height: 32px; line-height: 30px; background-color: #dde8ec; font-family: Arial; font-size: 13px; font-weight: bold; text-transform: uppercase;">
        ...
        <div style="float: right; width: 87.5%;">
            ...
            <div style="float: left; width: 25%; text-align: right;">
                <asp:DropDownList ID="ddlPartner" runat="server" Style="width: 99%; height: 26px; line-height: 26px; margin-top: 3px;">
                </asp:DropDownList>
            </div>
