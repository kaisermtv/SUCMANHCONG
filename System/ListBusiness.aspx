<%@ Page Title="QUẢN TRỊ NỘI DUNG" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ListBusiness.aspx.cs" Inherits="System_ListBusiness" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; height: 32px; line-height: 30px; background-color: #dde8ec; font-family: Arial; font-size: 13px; font-weight: bold; text-transform: uppercase;">
        <div style="float: left;">Nhóm kinh doanh</div>
        <div style="float: right;"><a href="Edit/BusinessEdit.aspx"><span style="border: solid 1px #f8fbfc; padding: 5px; font-size: 11px; font-weight: bold; padding-left: 20px; padding-right: 20px;">Thêm mới</span></a>&nbsp;</div>
    </div>
                ...
                <tr>
                    ...
                    <td class="page_table_item" style="width: 5%;">
                        <div class="page_table_item center">
                            <a href="Edit/BusinessEdit.aspx?Id=<%# Eval("Id") %>">
                                Sửa
                            </a>
                        </div>
                    </td>
                    ...
                    <td class="page_table_item" style="width: 5%;">
                        <div class="page_table_item center">
                            <a href="Del/DelBusiness.aspx?Id=<%# Eval("Id") %>">
                                Xóa
                            </a>
                        </div>
                    </td>
