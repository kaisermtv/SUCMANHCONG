...
public partial class ProductEdit : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if(ret > 0)
        {
            ScriptManager.RegisterClientScriptBlock(this,this.GetType(), "msg", "alert('Yêu cầu của quý khách được gửi đi thành công , Chúng tôi sẻ xem xét và trả lời bạn trong thời gian sớm nhất !'); ",true);
