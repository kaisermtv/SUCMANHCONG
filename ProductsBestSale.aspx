          ...
          {  %>
            <div class="col-md-3" style="margin-bottom:10px">
                <div style="background-color: #f9faf5; height: 375px; padding: 5px;">
                    <a style="width: 100%" href="/detailt.aspx?id=<%Response.Write(this.objTableProductBestSale.Rows[i]["Id"].ToString()); %>">
                        <img style="height: 250px; width: 100%" src="/images/Products/<%Response.Write(this.objTableProductBestSale.Rows[i]["Image"].ToString()); %>"
                     onerror="this.onerror = null; this.src = '../img/noImg2.jpg';"      alt=" Nổi bật" /></a>
                    ...
                    <div style="text-align: right; margin-top: -2px;">
                        <div style="font-family: Arial; font-size: 12px; color: #00a84b; font-weight: normal;
                            ...
                            <img src="Images/user.png" alt="So nguoi thich" style="width: 20px; margin-top: -8px;" />
                             <%Response.Write(this.objTableProductBestSale.Rows[i]["CountLike"].ToString()); %>
                        </div>
                    </div>
                    ...
                    <input type="button" value="Đã mua:  <%Response.Write(this.objTableProductBestSale.Rows[i]["CountBuy"].ToString()); %>" style="margin-top: -46px;" />
                </div>
