<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Detailt.aspx.cs" Inherits="Store_Detailt" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div style="width: 100%; background-color: #f6f6f6; border: solid 1px #c6c6c6;">
                    <div style="padding: 5px;">
                        ...
                        <br />
                        Email:  <% Response.Write(this.objTablePartner.Rows[0]["Phone"].ToString()); %>
                        <br />
                        Website:www.sucmanhcong.com
                    </div>
                     <img style ="width:98%; padding-left:5px; margin-bottom:10px;" src ="../images/Partner/<% if (this.objTablePartner.Rows.Count > 0) Response.Write(this.objTablePartner.Rows[0]["Image"].ToString()); else Response.Write("NpImg.jpg"); %>" alt = "Hinh dai dien" />
            ...
            <div class="col-md-9" style="float: left; width: 75%; height: 100%; vertical-align: top; text-align: justify;">
                <h3 style="text-align: justify; font-family: Arial; font-size: 16px; font-weight: bold; padding-top: 0px;">
                    <% if (this.objTable.Rows.Count > 0) Response.Write(this.objTable.Rows[0]["Name"].ToString()); %></h3>
                <hr style="width: 98%; color: #00ffff;" />
                <div style="width: 100%; text-align: justify; margin-top: 0px;">
                    <% if (this.objTable.Rows.Count > 0) Response.Write(this.objTable.Rows[0]["Content"].ToString()); %>
                </div>
            </div>
        </div>
    </div>
