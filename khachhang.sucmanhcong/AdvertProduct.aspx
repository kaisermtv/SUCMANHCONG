...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div style="width: 100%; height: 32px; line-height: 30px; margin-top: 30px; background-color: #dde8ec; font-family: Arial; font-size: 13px; font-weight: bold; text-transform: uppercase;">
        ...
        <div style="float: right; width: 85.5%;">
            ...
            <div style="float: right; width: 30%; text-align: right;">
                <asp:Button ID="btnSave" runat="server" Text="Ghi nhận" Style="height: 99%;" OnClick="btnSave_Click" />
                <asp:Button ID="btnCancel" runat="server" Text="Thoát" Style="height: 99%;" OnClick="btnCancel_Click" />
            </div>
        </div>
    </div>
